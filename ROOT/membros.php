	...
	<div class="pagediv">
		<div class="text-center divbox" id="top">
			<div class="setOpacity6">
				<h1><br><br></h1>
				<h1 style="color: #28a745;">Membros <i class="fas fa-users"></i></h1>
			...
			<div id="divmembros" class="row">
				<?php
				$row_membro = $membrodao->selectAllMembro(' where ativo = 1 and visivel = 1 and (idCargo <> 1 and idCargo <> 2 or idCargo is null) order by idCargo');
				if($row_membro != false && !is_null($row_membro)){
					foreach ($row_membro as $membro) {
						doCards::doMemberCard($membro);
					}
