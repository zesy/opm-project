...
$orq = OrquestraDAO::selectOrquestra();
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
...
<body>
	...
	<!-- DIV AGENDA -->
	<div class="pagediv">
		<div class="divbox" id="top" style="border: 0;">
			<div class="setOpacity6 text-center">
				<h1><br><br></h1>
				<h1 style="color: #28a745;">Vertentes</h1>
				<img src="img/logo/logo.jpg?v=<?php echo filemtime('img/logo/logo.jpg'); ?>" />
				<h1><br></h1>
			</div>
			<div class="container">

				<?php doCards::doVertCols(); ?>
